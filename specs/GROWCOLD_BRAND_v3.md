# GrowCold — Brand Language v3
> Foundation document for the GrowCold design system.  
...
GrowCold is a mobile-first warehouse management system for rural and suburban Indian cold-storage operators. The brand language must feel like a **smarter version of the paper register** operators already trust — warm, readable, unambiguous, and honest about network state.
...
*GrowCold Brand Language v3 — Foundation for design system implementation*  
