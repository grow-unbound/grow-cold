  ...
  return (
    <div className="auth-panel">
      {step === 'phone' ? (
        ...
        <>
          <div>
            <h1 className="text-lg font-semibold text-text-primary">{tAuth('enter_otp_title')}</h1>
            <p className="mt-1 text-caption text-text-secondary">{tAuth('enter_otp_help')}</p>
          </div>
          <p className="text-center text-caption text-text-secondary">
            <span className="text-text-secondary">{tAuth('otp_sent_to_prefix')}</span>{' '}
