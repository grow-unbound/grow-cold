...
>(({ className, ...props }, ref) => (
  <AlertDialogPortal>
    ...
    <AlertDialogPrimitive.Content
      ref={ref}
      className={cn(
        'fixed left-[50%] top-[50%] z-[60] grid w-[calc(100%_-_1.5rem)] max-w-md translate-x-[-50%] translate-y-[-50%] gap-4 rounded-base border border-border bg-white p-6 shadow-lg',
        className,
      )}
      {...props}
    />
...
>(({ className, children, ...props }, ref) => (
  <AlertDialogPrimitive.Action ref={ref} asChild {...props}>
    <Button variant="danger" className={cn('w-full sm:w-auto', className)}>
      {children}
    </Button>
