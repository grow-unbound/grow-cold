...
export function PartiesScreen() {
  ...
  return (
    <div className="relative flex min-h-0 w-full max-w-none flex-col bg-surface-subtle">
      ...
      <div className="mt-2 space-y-2 pb-12">
        ...
        {searching && filterTotal === 0 && !listQ.isPending && (
          <p className="text-caption text-text-tertiary">{t('parties.no_results_hint')}</p>
        )}
        ...
        {!listQ.isPending && !searching && flat.length === 0 && (
          <div className="card w-full py-8 text-center">
            <p className="text-body-sm text-text-secondary">{t('parties.empty_customers')}</p>
            <p className="mt-1 text-caption text-text-tertiary">{t('parties.empty_customers_hint')}</p>
          </div>
        )}
        ...
        {isFetchingNext && <p className="text-center text-caption text-text-tertiary">{t('parties.load_more')}</p>}
      </div>
