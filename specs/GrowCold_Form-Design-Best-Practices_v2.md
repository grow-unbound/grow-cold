...
- Never Delete any record, only soft-delete and mark the lot 'DELETED'. Deleted records are always filtered out
...
3. Each row shows: Lot No. | Type (Rent / Charges ) | Accrual Amount | Allocated Amount
